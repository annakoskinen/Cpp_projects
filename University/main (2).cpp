 ...
 *
 * Kuvaus:
 * Ohjelma toteuttaa yliopiston, joka sisältää opiskelijoita, opettajia ja kursseja. Ohjelman
 * käynnistyessä käyttäjältä odotetaan syötettä, jonka avulla yliopistoon lisätään, muokataan
 * tai tulostetaan tietoja.
 *
 * Ohjelmalle voi antaa seuraavia käskyjä:
 * - QUIT: Ohjelman suoritus päättyy arvoon EXIT_SUCCESS
 * - NEW_ACCOUNT: Yliopistoon voidaan lisätä opiskelijoita tai henkilökuntaa. Parametrinä
 * annetaan henkilön nimi. Henkilölle luodaan henkilönumero ja sähköpostiosoite.
 ...
 * - PRINT_STUDY_STATE: Tulostaa annetun opiskelijan opiskelutilanteen: meneillään olevat kurssit,
 * suoritetut kurssit sekä suoritettujen kurssien opintopistemäärän. Kurssit tulostetaan ilmottautumis-
 * ja suorittamisjärjestyksessä.
 * - PRINT_COMPLETED: Tulostaa annetun opiskelijan kurssisuoritukset ja kokonaisopintopistemäärän.
 * Kurssit tulostetaan suoritusjärjestyksessä.
 * - PRINT_SIGNUPS: Tulostaa annetulle kurssille ilmoittautuneet opiskelijat. Opiskelijat tulostetaan
